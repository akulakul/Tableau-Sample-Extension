...
(function () {
  ...
  $(document).ready(function () {
    ...
    tableau.extensions.initializeAsync().then(function () {
      ...
      // Fetch saved sheet name from settings
      const savedSheetName = tableau.extensions.settings.get('sheet');
      if (savedSheetName) {
        // We have saved a sheet name, show the selected marks
  ...
  // This variable will save off the function we can call to unregister listening
  // to marks-selected events
  ...
  function loadSelectedMarks (worksheetName) {
    ...
    // Add an event listener for the selection changed event on this worksheet
    unregisterEventHandlerFunction = worksheet.addEventListener(tableau.TableauEventType.MarkSelectionChanged,
